...
Then, if we have a query $Q$, it is possible to calculate the likelihood that a document sample generated this query, as we know for every term in the query what the probability is that one of the document samples generates that term: 
