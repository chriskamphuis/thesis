...
All metrics introduced are $@k$ metrics, this means that we only evaluate the documents ranked up to rank $k$. If $k=30$, we only consider the first $30$ documents produced by the system.
