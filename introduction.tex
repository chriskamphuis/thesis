...
\begin{enumerate}
	\item \emph{What are the benefits of using relational databases for information retrieval?} 
	\item \emph{How can we extend the benefits from using relational databases for information retrieval to using graph databases?} 
	\item \emph{Can we show practically an example where information retrieval research benefits from graph data?} 
\end{enumerate}
